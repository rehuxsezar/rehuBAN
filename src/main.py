...
# Telegram bot token
BOT_TOKEN = os.getenv('BOT_TOKEN') or '8091678858:AAE4uGruO2eeCtQedN6BAIhn-Q-RaY9MXno'
...
# Flask app for keep-alive (commented out for now to avoid conflict)
# app = Flask('')
# @app.route('/')
# def home():
#     return "I'm alive"
...
if __name__ == "__main__":
    # keep_alive()  # Commented out to avoid conflict with polling
